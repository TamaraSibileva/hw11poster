...
public class MovieManagerForNewLimit3Test {
    ...
    public void shouldAddMovie() {
        ...
        MovieItem[] expected = { Film1, Film2, };
    ...
    @Test
    public void shouldFindLastMoviesEqualsLimit3() {
    ...
    public void shouldFindLastForUpperLimitValue4() {
        ...
        MovieItem[] expected = { Film4, Film3, Film2 };
        MovieItem[] actual = manager.findLast();
